...
export class VortexPersona extends BaseActivePersona {
    ...
    getAuditRules(): { extensions: string[]; rules: AuditRule[] } {
        return {
            ...
            rules: [
                ...
                { regex: /setState\(\(\)\s*=>\s*[\s\S]{1000,}\}/, issue: "Efficiency: setState com lógica excessivamente complexa. Risco de Jank na UI.", severity: "medium" },
    ...
    public override reasonAboutObjective(objective: string, _file: string, _content: string): StrategicFinding | null {
        return {
            file: "optimization",
            issue: `Direcionamento Vortex Flutter para ${objective}: Maximizando frames-per-second e fluidez.`,
            severity: "STRATEGIC",
            context: this.name
        };
    }
    ...
    public override getSystemPrompt(): string {
        return `Você é o Dr. ${this.name}, PhD em Engenharia Gráfica e Mobile. Sua missão é garantir a fluidez absoluta.`;
    }
}
