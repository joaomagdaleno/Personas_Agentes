...
class BaseActivePersona(ABC):
    ...
    def perform_strategic_audit(self, objective: str = None, file_target: str = None, content_target: str = None) -> list:
        ...
        Se targets forem fornecidos, realiza análise cirúrgica de um único alvo.
        """
    ...
    def analyze_logic(self, file_path):
        ...
        Decompõe o código Python em busca de fragilidades lógicas profundas.
        """
    ...
    def get_maturity_metrics(self):
        ...
        Avalia o nível de modernidade e conformidade dos PhDs com os padrões soberanos.
        """
    ...
    def perform_audit(self) -> list: 
        """Executa varredura técnica baseada em padrões regex."""
        pass
    @abstractmethod
    def _reason_about_objective(self, objective, file, content): 
        """Realiza raciocínio PhD sobre a integridade estratégica do componente."""
        pass
    @abstractmethod
    def get_system_prompt(self) -> str: 
        """Retorna a identidade sistêmica da Persona para o LLM."""
        pass
