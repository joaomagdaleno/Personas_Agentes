...
/**
 * 🎭 Persona Dinâmica (PhD-on-Demand).
 * Instancia personas a partir do PersonaManifest sem precisar de arquivos individuais.
 */
export class DynamicPersona extends BaseActivePersona {
    private rules: any[];
    ...
    async performAudit(): Promise<any[]> {
        ...
        const results: any[] = [];
        const extensions = this.stack === "Flutter" ? [".dart"] : (this.stack === "Kotlin" ? [".kt"] : [".ts", ".py"]);
