...
/**
 * Monta as 8 Super Personas de Engenharia Soberana como plugins no micro-kernel DshContext.
 */
export function mountAllSuperPersonaPlugins(ctx: DshContext): void {
