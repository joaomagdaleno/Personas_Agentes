...
class FlowPersona(BaseActivePersona):
    """Especialista em fluxos de lógica Python."""
    def __init__(self, project_root):
        ...
        self.mission = "Manage complex control flows and states."
        self.stack = "Python"

    def perform_audit(self) -> list:
        """Realiza auditoria técnica focada em fluxos de lógica."""
        issues = []
                ...
                if file.endswith('.py'):
                    ...
                    try:
                        ...
                        if content.count('if ') > 15:
                            issues.append({'file': rel_path, 'issue': 'Excesso de condicionais. Considere simplificar o fluxo.', 'severity': 'medium', 'context': 'Flow'})
                    except Exception:
                        continue
        return issues
