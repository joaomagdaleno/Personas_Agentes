...
class GlobePersona(BaseActivePersona):
    """Especialista em internacionalização Python."""
    def __init__(self, project_root):
        ...
        self.mission = "Internationalization and formatting."
        self.stack = "Python"

    def perform_audit(self) -> list:
        """Realiza auditoria técnica focada em i18n."""
        issues = []
                ...
                if file.endswith('.py'):
                    ...
                    try:
                        ...
                        if "print('" in content or 'print("' in content:
                            if "_(" not in content:
                                issues.append({'file': rel_path, 'issue': 'String hardcoded sem tradução (i18n).', 'severity': 'low', 'context': 'Globe'})
                    except Exception:
                        continue
        return issues
