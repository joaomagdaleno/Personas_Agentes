...
class ScalePersona(BaseActivePersona):
    """Especialista em arquitetura Python."""
    def __init__(self, project_root):
        ...
        self.mission = "Modularity and scalability."
        self.stack = "Python"

    def perform_audit(self) -> list:
        """Realiza auditoria técnica focada em arquitetura."""
        issues = []
                ...
                if file.endswith('.py'):
                    ...
                    try:
                        ...
                        if len(content.split('\n')) > 500:
                            issues.append({'file': rel_path, 'issue': 'Arquivo muito longo. Sugere-se modularização.', 'severity': 'medium', 'context': 'Scale'})
                    except Exception:
                        continue
        return issues
