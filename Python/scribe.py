...
class ScribePersona(BaseActivePersona):
    """Especialista em documentação Python."""
    def __init__(self, project_root):
        ...
        self.mission = "Code clarity and docstrings."
        self.stack = "Python"

    def perform_audit(self) -> list:
        """Realiza auditoria técnica focada em documentação."""
        issues = []
                ...
                if file.endswith('.py'):
                    ...
                    try:
                        ...
                        if "def " in content and '"""' not in content:
                            issues.append({'file': rel_path, 'issue': 'Função sem docstring detectada.', 'severity': 'low', 'context': 'Scribe'})
                    except Exception:
                        continue
        return issues
