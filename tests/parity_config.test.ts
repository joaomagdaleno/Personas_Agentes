...
import * as parityConfig from "../src_local/engines/analysis/parity_config.ts";
...
describe("parity_config.ts Structure", () => {
    ...
    it("should maintain parity with external ignore_list", async () => {
        const { IGNORE_LIST: externalList } = await import("../src_local/engines/analysis/ignore_list.ts");
