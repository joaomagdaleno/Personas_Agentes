...
logger = logging.getLogger("TestStructuralAnalystDeep")
...
class TestStructuralAnalystDeep(unittest.TestCase):
    ...
    def test_complexity_calculation(self):
        ...
        logger.info("⚡ Testando cálculo de complexidade ciclomática...")
        code = """
def complex_func(x):
    if x > 0:
        for i in range(x):
    ...
    return x
        ...
        logger.info(f"✅ Complexidade calculada: {complexity}")

    def test_import_extraction(self):
        """Valida extração de dependências de diversos tipos de import."""
        logger.info("⚡ Testando extração de imports...")
        code = """
import os
...
from src_local.core import orchestrator
        ...
        logger.info("✅ Extração de imports validada.")

    def test_python_analysis_full(self):
        """Valida análise completa de um módulo Python."""
        logger.info("⚡ Testando análise completa Python...")
...
try:
    ...
    pass
        ...
        logger.info("✅ Detecção de falhas lógicas validada.")

    def test_component_mapping(self):
        """Valida classificação semântica de caminhos do projeto."""
        logger.info("⚡ Testando mapeamento de componentes...")
        ...
        logger.info("✅ Mapeamento de componentes validado.")

    def test_maturity_metrics(self):
        """Valida detecção de maturidade via presença de padrões core."""
        logger.info("⚡ Testando métricas de maturidade...")
        ...
        logger.info("✅ Métricas de maturidade validadas.")
